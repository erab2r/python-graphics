...
def draw_panda():
    ...
    # Draw ears
    draw_circle("black", 30, -70, 20)   # Left ear
    draw_circle("black", 30, 70, 20)    # Right ear
    draw_circle("white", 15, -70, 25)   # Left inner ear
    draw_circle("white", 15, 70, 25)    # Right inner ear

    # Draw eyes
    draw_circle("black", 15, -35, -40)   # Left eye
    draw_circle("black", 15, 35, -40)    # Right eye
    draw_circle("white", 7, -35, -35)    # Left eye white
    draw_circle("white", 7, 35, -35)     # Right eye white

    # Draw nose
    draw_circle("black", 10, 0, -60)
